...
export const stats = [
  { label: "Happy users", value: "120K+", icon: Sparkles },
  { label: "Transactions / day", value: "48K", icon: CreditCard },
  { label: "Data delivered", value: "2.4PB", icon: Wifi },
  { label: "Airtime sold", value: "₦3.1B", icon: Phone },
];
